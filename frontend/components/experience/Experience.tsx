  ...
  positions: [
    {
      ...
      duration: "2020–2024",
      applications: [{ title: "SportEdit", link: "#" }],
      achievements: [
    ...
    },
    {
      ...
      duration: "2019–2020",
      applications: [
        { title: "PhoneLine", link: "#" },
        { title: "GhostCall", link: "#" },
        { title: "PrankDial", link: "#" },
        { title: "Chatflix", link: "#" },
        { title: "Cogman Admin", link: "#" },
      ],
      achievements: [
    ...
    },
    {
      ...
      position: "Software Engineer",
      duration: "2018–2019",
      applications: [{ title: "Shimahin Ecommerce", link: "#" }],
      achievements: [
